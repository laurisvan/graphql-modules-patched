...
function createApplication(applicationConfig) {
  function applicationFactory(cfg) {
    ...
    const schema$1 = (
      applicationConfig.schemaBuilder || schema.makeExecutableSchema
    )({
      typeDefs,
      resolvers,
    });
...
function ensureDocumentNode(config, typeDefs) {
  function ensureEach(doc, i) {
    if (
      (doc === null || doc === void 0 ? void 0 : doc.kind) !==
...
function hasTypes(def) {
  return (
    ...
    ].includes(def.kind) && hasPropValue(def, 'types')
  );
}
